...
public class qulificationTB extends SuperEntity {
    private String Sid;
    ...
    public qulificationTB() {
    }

    public qulificationTB(String sid, String filed, String year, String result, String institiute, String any) {
        setSid(sid);
        this.setFiled(filed);
        this.setYear(year);
